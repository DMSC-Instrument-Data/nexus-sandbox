...
parser.add_argument("-s", "--scale", type=float, default=2, help='Scale factor to multiply the number of events. If the factor is greater than 1 it is rounded to the nearest integer and the number of events per pulse is increased by that factor. If the factor is less than 1 the number of pulses is reduced accordingly, keeping the number of events per pulse as in the original file.')
