...
set outp "ssd-large-sample-file.png"

set key t l
set title "DMSC workstation SSD, load 1 GByte (compressed 350 MByte) chunk size 4 MByte"
set xla "MPI ranks"
set yla "MB/s" offset 1
p \
  "ssd-large-sample-file-gzip" u 1:4 w p ti "GZIP" ls 100, \
  "ssd-large-sample-file-no-compression" u 1:4 w p ti "no compression" ls 210
